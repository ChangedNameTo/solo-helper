                  ...
                  <div className="space-y-12">
                    ...
                    <div className="border-b border-gray-900/10 pb-12">
                      ...
                      <p className="mt-1 text-sm leading-6 text-gray-600">
                        There are five stats. Each is given a value from 1 to 3.
                        When you make a move and roll dice, you usually add one
                        of your stats to your action die. The move will tell you
                        which stat to add, or give you a choice.
                        <br />
                        <br /> To assign stats, pick a bonus across each stat in
                        any order.
                      </p>
                    ...
                    <div className="border-b border-gray-900/10 pb-12">
                      ...
                      <p className="mt-1 text-sm leading-6 text-gray-600">
                        There are four gauge stats. These are stats that
                        fluctuate as your character is out on their journey.
                        <br />
