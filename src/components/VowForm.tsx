...
export default function VowForm(props) {
  ...
  return (
    <Transition appear show={vowFormContext.isOpen(props.vow.id)} as={React.Fragment}>
      <Dialog as="div" className="relative z-10" onClose={()=>vowFormContext.closeModal(props.vow.id)}>
        <Transition.Child
          as={React.Fragment}
                          ...
                          <div className="relative mt-2 rounded-md shadow-sm">
                            <div className="absolute inset-y-0 left-0 flex items-center">
                              ...
                              <select
                                ...
                                name="tier"
                                autoComplete="tier"
                                className="h-full rounded-md border-0 bg-transparent py-0 px-3 text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm"
                              >
                                <option>Epic</option>
