...
import ActionRollMessageListItem from "./ActionRollMessageListItem";
import { CommandMessage } from "../../Types/MessageTypes";

export default function CommandMessageListItem(props) {
  switch (props.message.fields.command) {
    case "/moveroll":{
      return(
        <ActionRollMessageListItem
    ...
    default: {
      return (
        <li
          key={props.message.date}
          className="bg-white relative flex pl-0.5 pr-2 rounded-lg"
        >
          <div
